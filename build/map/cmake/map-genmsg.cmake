...
message(STATUS "map: 0 messages, 0 services")

set(MSG_I_FLAGS "-Imap:/home/xining095/Carmaker/smartcar/miniEV_grad/src/map/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/map)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/map\")")
  # install generated code
  install(
