...
if("TRUE" STREQUAL "TRUE")
  set(lanelet2_extension_SOURCE_PREFIX /home/xining095/Carmaker/smartcar/miniEV_grad/src/common/lanelet2_extension)
  set(lanelet2_extension_DEVEL_PREFIX /home/xining095/Carmaker/smartcar/miniEV_grad/devel)
  ...
  set(lanelet2_extension_INSTALL_PREFIX /home/xining095/Carmaker/smartcar/miniEV_grad/install)
...
if(NOT "/home/xining095/Carmaker/smartcar/miniEV_grad/src/common/lanelet2_extension/include " STREQUAL " ")
  set(lanelet2_extension_INCLUDE_DIRS "")
  set(_include_dirs "/home/xining095/Carmaker/smartcar/miniEV_grad/src/common/lanelet2_extension/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lanelet2_extension' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xining095/Carmaker/smartcar/miniEV_grad/src/common/lanelet2_extension/${idir}'.  ${_report}")
    endif()
