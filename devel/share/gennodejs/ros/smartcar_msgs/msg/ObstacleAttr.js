...
class ObstacleAttr {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ObstacleAttr
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ObstacleAttr
    let len;
    let data = new ObstacleAttr(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ObstacleAttr(null);
    if (msg.id !== undefined) {
      resolved.id = msg.id;
    }
    else {
