...
class DynamicObjectArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DynamicObjectArray(null);
  ...
  static datatype() {
    ...
    return 'object_msgs/DynamicObjectArray';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'a26069a8a718d8b5a3c41201684648cc';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DynamicObjectArray(null);
...
module.exports = DynamicObjectArray;
