...
class DynamicObject {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PredictedPath.serialize(obj.path, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.path = PredictedPath.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PredictedPath.getMessageSize(object.path);
    return length + 16;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.path !== undefined) {
      resolved.path = PredictedPath.Resolve(msg.path)
    }
    else {
      resolved.path = new PredictedPath()
    }
