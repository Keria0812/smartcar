...
(cl:defmethod cl:initialize-instance :after ((m <TrafficLightRoi>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficLightRoi)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_msgs-msg:<TrafficLightRoi> is deprecated: use object_msgs-msg:TrafficLightRoi instead.")))
