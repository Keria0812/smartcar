...
(cl:defmethod cl:initialize-instance :after ((m <LampState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LampState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_msgs-msg:<LampState> is deprecated: use object_msgs-msg:LampState instead.")))
