...
(cl:defclass <TrafficLightRoiArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (rois
    :reader rois
    :initarg :rois
    :type (cl:vector object_msgs-msg:TrafficLightRoi)
   :initform (cl:make-array 0 :element-type 'object_msgs-msg:TrafficLightRoi :initial-element (cl:make-instance 'object_msgs-msg:TrafficLightRoi))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TrafficLightRoiArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficLightRoiArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_msgs-msg:<TrafficLightRoiArray> is deprecated: use object_msgs-msg:TrafficLightRoiArray instead.")))
...
(cl:defmethod rois-val ((m <TrafficLightRoiArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_msgs-msg:rois-val is deprecated.  Use object_msgs-msg:rois instead.")
  (rois m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrafficLightRoiArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'rois)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'object_msgs-msg:TrafficLightRoi))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TrafficLightRoiArray>)))
  ...
  "object_msgs/TrafficLightRoiArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TrafficLightRoiArray)))
  "Returns string type for a message object of type 'TrafficLightRoiArray"
  "object_msgs/TrafficLightRoiArray")
