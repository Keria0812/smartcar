...
(cl:defmethod cl:initialize-instance :after ((m <PredictedPath>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PredictedPath)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_msgs-msg:<PredictedPath> is deprecated: use object_msgs-msg:PredictedPath instead.")))
...
(cl:defmethod confidence-val ((m <PredictedPath>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_msgs-msg:confidence-val is deprecated.  Use object_msgs-msg:confidence instead.")
  (confidence m))
