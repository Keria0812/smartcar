...
(cl:defmethod cl:initialize-instance :after ((m <Shape>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Shape)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_msgs-msg:<Shape> is deprecated: use object_msgs-msg:Shape instead.")))
...
(cl:defmethod dimensions-val ((m <Shape>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_msgs-msg:dimensions-val is deprecated.  Use object_msgs-msg:dimensions instead.")
  (dimensions m))

(cl:ensure-generic-function 'footprint-val :lambda-list '(m))
(cl:defmethod footprint-val ((m <Shape>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_msgs-msg:footprint-val is deprecated.  Use object_msgs-msg:footprint instead.")
  (footprint m))
