...
(cl:defclass <TrafficLightState> (roslisp-msg-protocol:ros-message)
  ((lamp_states
    :reader lamp_states
    :initarg :lamp_states
    :type (cl:vector object_msgs-msg:LampState)
   :initform (cl:make-array 0 :element-type 'object_msgs-msg:LampState :initial-element (cl:make-instance 'object_msgs-msg:LampState)))
   (id
    :reader id
    :initarg :id
    :type cl:integer
...
(cl:defmethod cl:initialize-instance :after ((m <TrafficLightState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficLightState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_msgs-msg:<TrafficLightState> is deprecated: use object_msgs-msg:TrafficLightState instead.")))

(cl:ensure-generic-function 'lamp_states-val :lambda-list '(m))
(cl:defmethod lamp_states-val ((m <TrafficLightState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_msgs-msg:lamp_states-val is deprecated.  Use object_msgs-msg:lamp_states instead.")
  (lamp_states m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrafficLightState>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'lamp_states)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'object_msgs-msg:LampState))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TrafficLightState>)))
  ...
  (cl:format cl:nil "object_msgs/LampState[] lamp_states~%int32 id~%================================================================================~%MSG: object_msgs/LampState~%uint8 UNKNOWN=0~%uint8 RED=1~%uint8 GREEN=2~%uint8 YELLOW=3~%uint8 LEFT=4~%uint8 RIGHT=5~%uint8 UP=6~%uint8 DOWN=7~%uint32 type~%float32 confidence~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TrafficLightState)))
  "Returns full string definition for message of type 'TrafficLightState"
  (cl:format cl:nil "object_msgs/LampState[] lamp_states~%int32 id~%================================================================================~%MSG: object_msgs/LampState~%uint8 UNKNOWN=0~%uint8 RED=1~%uint8 GREEN=2~%uint8 YELLOW=3~%uint8 LEFT=4~%uint8 RIGHT=5~%uint8 UP=6~%uint8 DOWN=7~%uint32 type~%float32 confidence~%~%"))
