...
(cl:defclass <TrafficLightStateArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (states
    :reader states
    :initarg :states
    :type (cl:vector object_msgs-msg:TrafficLightState)
   :initform (cl:make-array 0 :element-type 'object_msgs-msg:TrafficLightState :initial-element (cl:make-instance 'object_msgs-msg:TrafficLightState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TrafficLightStateArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficLightStateArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_msgs-msg:<TrafficLightStateArray> is deprecated: use object_msgs-msg:TrafficLightStateArray instead.")))
...
(cl:defmethod states-val ((m <TrafficLightStateArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_msgs-msg:states-val is deprecated.  Use object_msgs-msg:states instead.")
  (states m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrafficLightStateArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'states)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'object_msgs-msg:TrafficLightState))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TrafficLightStateArray>)))
  ...
  "object_msgs/TrafficLightStateArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TrafficLightStateArray)))
  "Returns string type for a message object of type 'TrafficLightStateArray"
  "object_msgs/TrafficLightStateArray")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TrafficLightStateArray>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%object_msgs/TrafficLightState[] states~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: object_msgs/TrafficLightState~%object_msgs/LampState[] lamp_states~%int32 id~%================================================================================~%MSG: object_msgs/LampState~%uint8 UNKNOWN=0~%uint8 RED=1~%uint8 GREEN=2~%uint8 YELLOW=3~%uint8 LEFT=4~%uint8 RIGHT=5~%uint8 UP=6~%uint8 DOWN=7~%uint32 type~%float32 confidence~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TrafficLightStateArray)))
  "Returns full string definition for message of type 'TrafficLightStateArray"
  (cl:format cl:nil "std_msgs/Header header~%object_msgs/TrafficLightState[] states~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: object_msgs/TrafficLightState~%object_msgs/LampState[] lamp_states~%int32 id~%================================================================================~%MSG: object_msgs/LampState~%uint8 UNKNOWN=0~%uint8 RED=1~%uint8 GREEN=2~%uint8 YELLOW=3~%uint8 LEFT=4~%uint8 RIGHT=5~%uint8 UP=6~%uint8 DOWN=7~%uint32 type~%float32 confidence~%~%"))
