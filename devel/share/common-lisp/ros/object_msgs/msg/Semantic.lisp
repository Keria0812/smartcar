...
(cl:defmethod cl:initialize-instance :after ((m <Semantic>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Semantic)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_msgs-msg:<Semantic> is deprecated: use object_msgs-msg:Semantic instead.")))
