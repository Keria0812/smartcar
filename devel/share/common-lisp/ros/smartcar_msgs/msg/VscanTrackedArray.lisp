...
(cl:defclass <VscanTrackedArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (obj_tracked
    :reader obj_tracked
    :initarg :obj_tracked
    :type (cl:vector smartcar_msgs-msg:VscanTracked)
   :initform (cl:make-array 0 :element-type 'smartcar_msgs-msg:VscanTracked :initial-element (cl:make-instance 'smartcar_msgs-msg:VscanTracked))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <VscanTrackedArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VscanTrackedArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<VscanTrackedArray> is deprecated: use smartcar_msgs-msg:VscanTrackedArray instead.")))
...
(cl:defmethod obj_tracked-val ((m <VscanTrackedArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:obj_tracked-val is deprecated.  Use smartcar_msgs-msg:obj_tracked instead.")
  (obj_tracked m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VscanTrackedArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obj_tracked)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'smartcar_msgs-msg:VscanTracked))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VscanTrackedArray>)))
  ...
  "smartcar_msgs/VscanTrackedArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VscanTrackedArray)))
  "Returns string type for a message object of type 'VscanTrackedArray"
  "smartcar_msgs/VscanTrackedArray")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VscanTrackedArray>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%VscanTracked[] obj_tracked~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: smartcar_msgs/VscanTracked~%geometry_msgs/Point position~%float32 orientation~%float32 velocity~%GeometricRectangle geo_rect~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: smartcar_msgs/GeometricRectangle~%float32 wl~%float32 wr~%float32 lf~%float32 lb~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VscanTrackedArray)))
  "Returns full string definition for message of type 'VscanTrackedArray"
  (cl:format cl:nil "std_msgs/Header header~%VscanTracked[] obj_tracked~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: smartcar_msgs/VscanTracked~%geometry_msgs/Point position~%float32 orientation~%float32 velocity~%GeometricRectangle geo_rect~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: smartcar_msgs/GeometricRectangle~%float32 wl~%float32 wr~%float32 lf~%float32 lb~%~%"))
