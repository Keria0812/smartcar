...
(cl:defmethod cl:initialize-instance :after ((m <ControlCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControlCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<ControlCommand> is deprecated: use smartcar_msgs-msg:ControlCommand instead.")))
...
(cl:defmethod linear_acceleration-val ((m <ControlCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:linear_acceleration-val is deprecated.  Use smartcar_msgs-msg:linear_acceleration instead.")
...
(cl:defmethod steering_speed-val ((m <ControlCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:steering_speed-val is deprecated.  Use smartcar_msgs-msg:steering_speed instead.")
  (steering_speed m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ControlCommand>)))
  ...
  "4c9d4b2ad7fccef1741b334eb90a1eff")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ControlCommand)))
  "Returns md5sum for a message object of type 'ControlCommand"
  "4c9d4b2ad7fccef1741b334eb90a1eff")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ControlCommand>)))
  ...
  (cl:format cl:nil "float64 linear_velocity #m/s~%float64 linear_acceleration #m/s^2~%float64 steering_angle #rad~%float64 steering_speed #rad/s~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ControlCommand)))
  "Returns full string definition for message of type 'ControlCommand"
  (cl:format cl:nil "float64 linear_velocity #m/s~%float64 linear_acceleration #m/s^2~%float64 steering_angle #rad~%float64 steering_speed #rad/s~%~%"))
