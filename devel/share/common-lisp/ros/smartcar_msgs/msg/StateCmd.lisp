...
(cl:defmethod cl:initialize-instance :after ((m <StateCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StateCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<StateCmd> is deprecated: use smartcar_msgs-msg:StateCmd instead.")))
