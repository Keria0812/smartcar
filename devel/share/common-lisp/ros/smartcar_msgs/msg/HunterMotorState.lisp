...
(cl:defmethod cl:initialize-instance :after ((m <HunterMotorState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HunterMotorState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<HunterMotorState> is deprecated: use smartcar_msgs-msg:HunterMotorState instead.")))

(cl:ensure-generic-function 'current-val :lambda-list '(m))
(cl:defmethod current-val ((m <HunterMotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:current-val is deprecated.  Use smartcar_msgs-msg:current instead.")
  (current m))

(cl:ensure-generic-function 'rpm-val :lambda-list '(m))
(cl:defmethod rpm-val ((m <HunterMotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:rpm-val is deprecated.  Use smartcar_msgs-msg:rpm instead.")
  (rpm m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <HunterMotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:temperature-val is deprecated.  Use smartcar_msgs-msg:temperature instead.")
  (temperature m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HunterMotorState>)))
  ...
  "smartcar_msgs/HunterMotorState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HunterMotorState)))
  "Returns string type for a message object of type 'HunterMotorState"
  "smartcar_msgs/HunterMotorState")
