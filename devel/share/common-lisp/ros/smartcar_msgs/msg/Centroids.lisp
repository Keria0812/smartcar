...
(cl:defmethod cl:initialize-instance :after ((m <Centroids>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Centroids)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<Centroids> is deprecated: use smartcar_msgs-msg:Centroids instead.")))
...
(cl:defmethod points-val ((m <Centroids>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:points-val is deprecated.  Use smartcar_msgs-msg:points instead.")
  (points m))
