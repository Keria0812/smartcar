...
(cl:defmethod cl:initialize-instance :after ((m <IndicatorCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IndicatorCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<IndicatorCmd> is deprecated: use smartcar_msgs-msg:IndicatorCmd instead.")))
...
(cl:defmethod l-val ((m <IndicatorCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:l-val is deprecated.  Use smartcar_msgs-msg:l instead.")
  (l m))
