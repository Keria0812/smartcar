...
(cl:defclass <VscanTracked> (roslisp-msg-protocol:ros-message)
  ((position
   ...
   (geo_rect
    :reader geo_rect
    :initarg :geo_rect
    :type smartcar_msgs-msg:GeometricRectangle
    :initform (cl:make-instance 'smartcar_msgs-msg:GeometricRectangle)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <VscanTracked>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VscanTracked)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<VscanTracked> is deprecated: use smartcar_msgs-msg:VscanTracked instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <VscanTracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:position-val is deprecated.  Use smartcar_msgs-msg:position instead.")
  (position m))
...
(cl:defmethod geo_rect-val ((m <VscanTracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:geo_rect-val is deprecated.  Use smartcar_msgs-msg:geo_rect instead.")
  (geo_rect m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VscanTracked>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point position~%float32 orientation~%float32 velocity~%GeometricRectangle geo_rect~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: smartcar_msgs/GeometricRectangle~%float32 wl~%float32 wr~%float32 lf~%float32 lb~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VscanTracked)))
  "Returns full string definition for message of type 'VscanTracked"
  (cl:format cl:nil "geometry_msgs/Point position~%float32 orientation~%float32 velocity~%GeometricRectangle geo_rect~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: smartcar_msgs/GeometricRectangle~%float32 wl~%float32 wr~%float32 lf~%float32 lb~%~%"))
