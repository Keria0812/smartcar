...
(cl:defclass <HunterStatus> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (motor_states
    ...
    :type (cl:vector smartcar_msgs-msg:HunterMotorState)
   :initform (cl:make-array 3 :element-type 'smartcar_msgs-msg:HunterMotorState :initial-element (cl:make-instance 'smartcar_msgs-msg:HunterMotorState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <HunterStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HunterStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<HunterStatus> is deprecated: use smartcar_msgs-msg:HunterStatus instead.")))
...
(cl:defmethod steering_angle-val ((m <HunterStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:steering_angle-val is deprecated.  Use smartcar_msgs-msg:steering_angle instead.")
  (steering_angle m))

(cl:ensure-generic-function 'base_state-val :lambda-list '(m))
(cl:defmethod base_state-val ((m <HunterStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:base_state-val is deprecated.  Use smartcar_msgs-msg:base_state instead.")
  (base_state m))
...
(cl:defmethod fault_code-val ((m <HunterStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:fault_code-val is deprecated.  Use smartcar_msgs-msg:fault_code instead.")
  (fault_code m))

(cl:ensure-generic-function 'battery_voltage-val :lambda-list '(m))
(cl:defmethod battery_voltage-val ((m <HunterStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:battery_voltage-val is deprecated.  Use smartcar_msgs-msg:battery_voltage instead.")
  (battery_voltage m))

(cl:ensure-generic-function 'motor_states-val :lambda-list '(m))
(cl:defmethod motor_states-val ((m <HunterStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:motor_states-val is deprecated.  Use smartcar_msgs-msg:motor_states instead.")
  (motor_states m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HunterStatus>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'motor_states)))
    (cl:dotimes (i 3)
    (cl:setf (cl:aref vals i) (cl:make-instance 'smartcar_msgs-msg:HunterMotorState))
