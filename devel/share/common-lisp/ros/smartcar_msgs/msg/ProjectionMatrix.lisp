...
(cl:defmethod cl:initialize-instance :after ((m <ProjectionMatrix>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ProjectionMatrix)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<ProjectionMatrix> is deprecated: use smartcar_msgs-msg:ProjectionMatrix instead.")))
...
(cl:defmethod projection_matrix-val ((m <ProjectionMatrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:projection_matrix-val is deprecated.  Use smartcar_msgs-msg:projection_matrix instead.")
  (projection_matrix m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ProjectionMatrix>)))
  ...
  "smartcar_msgs/ProjectionMatrix")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ProjectionMatrix)))
  "Returns string type for a message object of type 'ProjectionMatrix"
  "smartcar_msgs/ProjectionMatrix")
