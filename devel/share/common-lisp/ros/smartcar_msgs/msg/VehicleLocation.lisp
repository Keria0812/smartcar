...
(cl:defmethod cl:initialize-instance :after ((m <VehicleLocation>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VehicleLocation)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<VehicleLocation> is deprecated: use smartcar_msgs-msg:VehicleLocation instead.")))
...
(cl:defmethod lane_array_id-val ((m <VehicleLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:lane_array_id-val is deprecated.  Use smartcar_msgs-msg:lane_array_id instead.")
  (lane_array_id m))

(cl:ensure-generic-function 'waypoint_index-val :lambda-list '(m))
(cl:defmethod waypoint_index-val ((m <VehicleLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:waypoint_index-val is deprecated.  Use smartcar_msgs-msg:waypoint_index instead.")
  (waypoint_index m))
