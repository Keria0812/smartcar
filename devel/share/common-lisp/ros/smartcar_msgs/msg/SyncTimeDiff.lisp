...
(cl:defmethod cl:initialize-instance :after ((m <SyncTimeDiff>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SyncTimeDiff)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<SyncTimeDiff> is deprecated: use smartcar_msgs-msg:SyncTimeDiff instead.")))
...
(cl:defmethod camera-val ((m <SyncTimeDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:camera-val is deprecated.  Use smartcar_msgs-msg:camera instead.")
  (camera m))

(cl:ensure-generic-function 'lidar-val :lambda-list '(m))
(cl:defmethod lidar-val ((m <SyncTimeDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:lidar-val is deprecated.  Use smartcar_msgs-msg:lidar instead.")
  (lidar m))
