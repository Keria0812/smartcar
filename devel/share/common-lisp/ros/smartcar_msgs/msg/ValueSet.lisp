...
(cl:defmethod cl:initialize-instance :after ((m <ValueSet>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ValueSet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<ValueSet> is deprecated: use smartcar_msgs-msg:ValueSet instead.")))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <ValueSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:center-val is deprecated.  Use smartcar_msgs-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <ValueSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:range-val is deprecated.  Use smartcar_msgs-msg:range instead.")
  (range m))
