...
(cl:defmethod cl:initialize-instance :after ((m <TrafficLightResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficLightResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<TrafficLightResult> is deprecated: use smartcar_msgs-msg:TrafficLightResult instead.")))
...
(cl:defmethod light_id-val ((m <TrafficLightResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:light_id-val is deprecated.  Use smartcar_msgs-msg:light_id instead.")
  (light_id m))

(cl:ensure-generic-function 'recognition_result-val :lambda-list '(m))
(cl:defmethod recognition_result-val ((m <TrafficLightResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:recognition_result-val is deprecated.  Use smartcar_msgs-msg:recognition_result instead.")
...
(cl:defmethod recognition_result_str-val ((m <TrafficLightResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:recognition_result_str-val is deprecated.  Use smartcar_msgs-msg:recognition_result_str instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TrafficLightResult>)))
  ...
  "smartcar_msgs/TrafficLightResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TrafficLightResult)))
  "Returns string type for a message object of type 'TrafficLightResult"
  "smartcar_msgs/TrafficLightResult")
