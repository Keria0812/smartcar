...
(cl:defmethod cl:initialize-instance :after ((m <AccelCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AccelCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<AccelCmd> is deprecated: use smartcar_msgs-msg:AccelCmd instead.")))
...
(cl:defmethod accel-val ((m <AccelCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:accel-val is deprecated.  Use smartcar_msgs-msg:accel instead.")
  (accel m))
