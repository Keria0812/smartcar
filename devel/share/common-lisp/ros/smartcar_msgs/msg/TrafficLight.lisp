...
(cl:defmethod cl:initialize-instance :after ((m <TrafficLight>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficLight)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<TrafficLight> is deprecated: use smartcar_msgs-msg:TrafficLight instead.")))
...
(cl:defmethod traffic_light-val ((m <TrafficLight>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:traffic_light-val is deprecated.  Use smartcar_msgs-msg:traffic_light instead.")
  (traffic_light m))
