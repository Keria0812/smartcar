...
(cl:defmethod cl:initialize-instance :after ((m <SteerCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SteerCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<SteerCmd> is deprecated: use smartcar_msgs-msg:SteerCmd instead.")))
