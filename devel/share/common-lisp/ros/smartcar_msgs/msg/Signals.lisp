...
(cl:defclass <Signals> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (Signals
    :reader Signals
    :initarg :Signals
    :type (cl:vector smartcar_msgs-msg:ExtractedPosition)
   :initform (cl:make-array 0 :element-type 'smartcar_msgs-msg:ExtractedPosition :initial-element (cl:make-instance 'smartcar_msgs-msg:ExtractedPosition))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Signals>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Signals)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<Signals> is deprecated: use smartcar_msgs-msg:Signals instead.")))
...
(cl:defmethod Signals-val ((m <Signals>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:Signals-val is deprecated.  Use smartcar_msgs-msg:Signals instead.")
  (Signals m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Signals>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'Signals)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'smartcar_msgs-msg:ExtractedPosition))
