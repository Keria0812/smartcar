...
(cl:defclass <VehicleCmd> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (steer_cmd
    :reader steer_cmd
    :initarg :steer_cmd
    :type smartcar_msgs-msg:SteerCmd
    :initform (cl:make-instance 'smartcar_msgs-msg:SteerCmd))
   (accel_cmd
    :reader accel_cmd
    :initarg :accel_cmd
    :type smartcar_msgs-msg:AccelCmd
    :initform (cl:make-instance 'smartcar_msgs-msg:AccelCmd))
   (brake_cmd
    :reader brake_cmd
    :initarg :brake_cmd
    :type smartcar_msgs-msg:BrakeCmd
    :initform (cl:make-instance 'smartcar_msgs-msg:BrakeCmd))
   (lamp_cmd
    :reader lamp_cmd
    :initarg :lamp_cmd
    :type smartcar_msgs-msg:LampCmd
    :initform (cl:make-instance 'smartcar_msgs-msg:LampCmd))
   (gear
    :reader gear
    :initarg :gear
    :type cl:integer
   ...
   (ctrl_cmd
    :reader ctrl_cmd
    :initarg :ctrl_cmd
    :type smartcar_msgs-msg:ControlCommand
    :initform (cl:make-instance 'smartcar_msgs-msg:ControlCommand))
   (emergency
    :reader emergency
    :initarg :emergency
    :type cl:integer
...
(cl:defmethod cl:initialize-instance :after ((m <VehicleCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VehicleCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smartcar_msgs-msg:<VehicleCmd> is deprecated: use smartcar_msgs-msg:VehicleCmd instead.")))
...
(cl:defmethod steer_cmd-val ((m <VehicleCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:steer_cmd-val is deprecated.  Use smartcar_msgs-msg:steer_cmd instead.")
  (steer_cmd m))

(cl:ensure-generic-function 'accel_cmd-val :lambda-list '(m))
(cl:defmethod accel_cmd-val ((m <VehicleCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:accel_cmd-val is deprecated.  Use smartcar_msgs-msg:accel_cmd instead.")
  (accel_cmd m))

(cl:ensure-generic-function 'brake_cmd-val :lambda-list '(m))
(cl:defmethod brake_cmd-val ((m <VehicleCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:brake_cmd-val is deprecated.  Use smartcar_msgs-msg:brake_cmd instead.")
  (brake_cmd m))

(cl:ensure-generic-function 'lamp_cmd-val :lambda-list '(m))
(cl:defmethod lamp_cmd-val ((m <VehicleCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:lamp_cmd-val is deprecated.  Use smartcar_msgs-msg:lamp_cmd instead.")
  (lamp_cmd m))
...
(cl:defmethod mode-val ((m <VehicleCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:mode-val is deprecated.  Use smartcar_msgs-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'twist_cmd-val :lambda-list '(m))
(cl:defmethod twist_cmd-val ((m <VehicleCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:twist_cmd-val is deprecated.  Use smartcar_msgs-msg:twist_cmd instead.")
  (twist_cmd m))

(cl:ensure-generic-function 'ctrl_cmd-val :lambda-list '(m))
(cl:defmethod ctrl_cmd-val ((m <VehicleCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:ctrl_cmd-val is deprecated.  Use smartcar_msgs-msg:ctrl_cmd instead.")
  (ctrl_cmd m))

(cl:ensure-generic-function 'emergency-val :lambda-list '(m))
(cl:defmethod emergency-val ((m <VehicleCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smartcar_msgs-msg:emergency-val is deprecated.  Use smartcar_msgs-msg:emergency instead.")
  (emergency m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VehicleCmd>)))
  ...
  (cl:format cl:nil "Header header~%smartcar_msgs/SteerCmd steer_cmd~%smartcar_msgs/AccelCmd accel_cmd~%smartcar_msgs/BrakeCmd brake_cmd~%smartcar_msgs/LampCmd lamp_cmd~%int32 gear~%int32 mode~%geometry_msgs/TwistStamped twist_cmd~%smartcar_msgs/ControlCommand ctrl_cmd~%int32 emergency~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: smartcar_msgs/SteerCmd~%Header header~%int32 steer~%~%================================================================================~%MSG: smartcar_msgs/AccelCmd~%Header header~%int32 accel~%~%================================================================================~%MSG: smartcar_msgs/BrakeCmd~%Header header~%int32 brake~%~%================================================================================~%MSG: smartcar_msgs/LampCmd~%Header header~%int32 l~%int32 r~%~%================================================================================~%MSG: geometry_msgs/TwistStamped~%# A twist with reference coordinate frame and timestamp~%Header header~%Twist twist~%~%================================================================================~%MSG: geometry_msgs/Twist~%# This expresses velocity in free space broken into its linear and angular parts.~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: smartcar_msgs/ControlCommand~%float64 linear_velocity #m/s~%float64 linear_acceleration #m/s^2~%float64 steering_angle #rad~%float64 steering_speed #rad/s~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VehicleCmd)))
  "Returns full string definition for message of type 'VehicleCmd"
  (cl:format cl:nil "Header header~%smartcar_msgs/SteerCmd steer_cmd~%smartcar_msgs/AccelCmd accel_cmd~%smartcar_msgs/BrakeCmd brake_cmd~%smartcar_msgs/LampCmd lamp_cmd~%int32 gear~%int32 mode~%geometry_msgs/TwistStamped twist_cmd~%smartcar_msgs/ControlCommand ctrl_cmd~%int32 emergency~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: smartcar_msgs/SteerCmd~%Header header~%int32 steer~%~%================================================================================~%MSG: smartcar_msgs/AccelCmd~%Header header~%int32 accel~%~%================================================================================~%MSG: smartcar_msgs/BrakeCmd~%Header header~%int32 brake~%~%================================================================================~%MSG: smartcar_msgs/LampCmd~%Header header~%int32 l~%int32 r~%~%================================================================================~%MSG: geometry_msgs/TwistStamped~%# A twist with reference coordinate frame and timestamp~%Header header~%Twist twist~%~%================================================================================~%MSG: geometry_msgs/Twist~%# This expresses velocity in free space broken into its linear and angular parts.~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: smartcar_msgs/ControlCommand~%float64 linear_velocity #m/s~%float64 linear_acceleration #m/s^2~%float64 steering_angle #rad~%float64 steering_speed #rad/s~%~%"))
