...
if("TRUE" STREQUAL "TRUE")
  set(naive_motion_predict_SOURCE_PREFIX /home/xining095/Carmaker/smartcar/miniEV_grad/src/prediction/motion_predictor/naive_motion_predict)
  set(naive_motion_predict_DEVEL_PREFIX /home/xining095/Carmaker/smartcar/miniEV_grad/devel)
  ...
  set(naive_motion_predict_INSTALL_PREFIX /home/xining095/Carmaker/smartcar/miniEV_grad/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'naive_motion_predict' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xining095/Carmaker/smartcar/miniEV_grad/src/prediction/motion_predictor/naive_motion_predict/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;sensor_msgs;smartcar_msgs;tf")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(naive_motion_predict_EXPORTED_TARGETS ${${naive_motion_predict_dep}_EXPORTED_TARGETS})
endforeach()
