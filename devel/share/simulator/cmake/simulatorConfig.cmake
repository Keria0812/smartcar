...
if("TRUE" STREQUAL "TRUE")
  set(simulator_SOURCE_PREFIX /home/xining095/Carmaker/smartcar/miniEV_grad/src/simulation/simulator)
  set(simulator_DEVEL_PREFIX /home/xining095/Carmaker/smartcar/miniEV_grad/devel)
  ...
  set(simulator_INSTALL_PREFIX /home/xining095/Carmaker/smartcar/miniEV_grad/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simulator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xining095/Carmaker/smartcar/miniEV_grad/src/simulation/simulator/${idir}'.  ${_report}")
    endif()
...
set(depends "smartcar_msgs;message_generation;message_runtime;roscpp;std_msgs;nav_msgs")
