...
"""autogenerated by genpy from object_msgs/DynamicObject.msg. Do not edit."""
import codecs
import sys
...
class DynamicObject(genpy.Message):
  _md5sum = "610fd6e075abe353ed2adc26d792ab75"
  _type = "object_msgs/DynamicObject"
...
float32 y
float32 z"""
  __slots__ = ['id','semantic','state','shape','path']
  _slot_types = ['string','object_msgs/Semantic','object_msgs/State','object_msgs/Shape','object_msgs/PredictedPath']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.semantic is None:
        self.semantic = object_msgs.msg.Semantic()
      if self.state is None:
        self.state = object_msgs.msg.State()
      if self.shape is None:
        self.shape = object_msgs.msg.Shape()
      if self.path is None:
        self.path = object_msgs.msg.PredictedPath()
    else:
      self.id = ''
      self.semantic = object_msgs.msg.Semantic()
      self.state = object_msgs.msg.State()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.path.confidence,) = _get_struct_d().unpack(str[start:end])
      return self
