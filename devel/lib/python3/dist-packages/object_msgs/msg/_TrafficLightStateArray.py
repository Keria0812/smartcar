...
"""autogenerated by genpy from object_msgs/TrafficLightStateArray.msg. Do not edit."""
import codecs
import sys
...
class TrafficLightStateArray(genpy.Message):
  ...
  _type = "object_msgs/TrafficLightStateArray"
...
float32 confidence"""
  ...
  _slot_types = ['std_msgs/Header','object_msgs/TrafficLightState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = object_msgs.msg.TrafficLightState()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.lamp_states = []
        for i in range(0, length):
          val2 = object_msgs.msg.LampState()
          _x = val2
          start = end
          end += 8
