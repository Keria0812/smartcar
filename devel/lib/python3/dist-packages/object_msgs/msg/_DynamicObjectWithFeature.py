...
"""autogenerated by genpy from object_msgs/DynamicObjectWithFeature.msg. Do not edit."""
import codecs
import sys
...
class DynamicObjectWithFeature(genpy.Message):
  _md5sum = "f3fa336b86220cf5cb282cd6d9474522"
  _type = "object_msgs/DynamicObjectWithFeature"
...
"""
  ...
  _slot_types = ['object_msgs/DynamicObject','object_msgs/Feature']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.object is None:
        self.object = object_msgs.msg.DynamicObject()
      if self.feature is None:
        self.feature = object_msgs.msg.Feature()
    else:
      self.object = object_msgs.msg.DynamicObject()
      self.feature = object_msgs.msg.Feature()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.object.path.path)
      buff.write(_struct_I.pack(length))
      for val1 in self.object.path.path:
        _v7 = val1.header
        _x = _v7.seq
        buff.write(_get_struct_I().pack(_x))
        _v8 = _v7.stamp
      ...
      _x = self
      buff.write(_get_struct_d3I().pack(_x.object.path.confidence, _x.feature.cluster.header.seq, _x.feature.cluster.header.stamp.secs, _x.feature.cluster.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = object_msgs.msg.PredictedPath()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.path = []
      ...
      for i in range(0, length):
        ...
        self.object.path.path.append(val1)
      _x = self
      start = end
      end += 20
      (_x.object.path.confidence, _x.feature.cluster.header.seq, _x.feature.cluster.header.stamp.secs, _x.feature.cluster.header.stamp.nsecs,) = _get_struct_d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
