...
"""autogenerated by genpy from object_msgs/TrafficLightRoiArray.msg. Do not edit."""
import codecs
import sys
...
class TrafficLightRoiArray(genpy.Message):
  ...
  _type = "object_msgs/TrafficLightRoiArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','object_msgs/TrafficLightRoi[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = object_msgs.msg.TrafficLightRoi()
        _v2 = val1.roi
        _x = _v2
        start = end
        end += 17
