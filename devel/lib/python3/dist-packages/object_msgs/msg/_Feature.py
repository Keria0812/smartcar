...
"""autogenerated by genpy from object_msgs/Feature.msg. Do not edit."""
import codecs
import sys
...
class Feature(genpy.Message):
  _md5sum = "bb748248ed86ccca2e45409c0a214eea"
  _type = "object_msgs/Feature"
...
bool do_rectify
"""
  __slots__ = ['cluster','roi']
  _slot_types = ['sensor_msgs/PointCloud2','sensor_msgs/RegionOfInterest']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B4IB().pack(_x.cluster.is_dense, _x.roi.x_offset, _x.roi.y_offset, _x.roi.height, _x.roi.width, _x.roi.do_rectify))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.cluster.is_dense, _x.roi.x_offset, _x.roi.y_offset, _x.roi.height, _x.roi.width, _x.roi.do_rectify,) = _get_struct_B4IB().unpack(str[start:end])
