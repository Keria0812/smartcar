...
"""autogenerated by genpy from smartcar_msgs/VscanTracked.msg. Do not edit."""
import codecs
import sys
...
class VscanTracked(genpy.Message):
  ...
  _type = "smartcar_msgs/VscanTracked"
...
float32 lb"""
  ...
  _slot_types = ['geometry_msgs/Point','float32','float32','smartcar_msgs/GeometricRectangle']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.geo_rect is None:
        self.geo_rect = smartcar_msgs.msg.GeometricRectangle()
    else:
      self.position = geometry_msgs.msg.Point()
      self.orientation = 0.
      self.velocity = 0.
