...
"""autogenerated by genpy from smartcar_msgs/CloudClusterArray.msg. Do not edit."""
import codecs
import sys
...
class CloudClusterArray(genpy.Message):
  ...
  _type = "smartcar_msgs/CloudClusterArray"
...
float32 z"""
  ...
  _slot_types = ['std_msgs/Header','smartcar_msgs/CloudCluster[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = smartcar_msgs.msg.CloudCluster()
        _v37 = val1.header
        start = end
        end += 4
