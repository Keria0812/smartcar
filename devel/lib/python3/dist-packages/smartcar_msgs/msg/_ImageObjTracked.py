...
"""autogenerated by genpy from smartcar_msgs/ImageObjTracked.msg. Do not edit."""
import codecs
import sys
...
class ImageObjTracked(genpy.Message):
  ...
  _type = "smartcar_msgs/ImageObjTracked"
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','uint8','int32[]','smartcar_msgs/ImageRectRanged[]','int32[]','int32[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = smartcar_msgs.msg.ImageRectRanged()
        _v2 = val1.rect
        _x = _v2
        start = end
        end += 20
