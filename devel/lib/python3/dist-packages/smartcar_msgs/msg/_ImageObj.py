...
"""autogenerated by genpy from smartcar_msgs/ImageObj.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','smartcar_msgs/ImageRect[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = smartcar_msgs.msg.ImageRect()
        _x = val1
        start = end
        end += 20
