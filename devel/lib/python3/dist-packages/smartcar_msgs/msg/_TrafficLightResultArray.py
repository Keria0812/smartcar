...
"""autogenerated by genpy from smartcar_msgs/TrafficLightResultArray.msg. Do not edit."""
import codecs
import sys
...
class TrafficLightResultArray(genpy.Message):
  ...
  _type = "smartcar_msgs/TrafficLightResultArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','smartcar_msgs/TrafficLightResult[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = smartcar_msgs.msg.TrafficLightResult()
        _v3 = val1.header
        start = end
        end += 4
