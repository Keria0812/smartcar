...
"""autogenerated by genpy from smartcar_msgs/RemoteCmd.msg. Do not edit."""
import codecs
import sys
...
class RemoteCmd(genpy.Message):
  _md5sum = "8e7e759a4d90007f22d93622c3d044bd"
  _type = "smartcar_msgs/RemoteCmd"
...
float64 steering_speed #rad/s"""
  ...
  _slot_types = ['std_msgs/Header','smartcar_msgs/VehicleCmd','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.vehicle_cmd is None:
        self.vehicle_cmd = smartcar_msgs.msg.VehicleCmd()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.vehicle_cmd.twist_cmd.twist.linear.x, _x.vehicle_cmd.twist_cmd.twist.linear.y, _x.vehicle_cmd.twist_cmd.twist.linear.z, _x.vehicle_cmd.twist_cmd.twist.angular.x, _x.vehicle_cmd.twist_cmd.twist.angular.y, _x.vehicle_cmd.twist_cmd.twist.angular.z, _x.vehicle_cmd.ctrl_cmd.linear_velocity, _x.vehicle_cmd.ctrl_cmd.linear_acceleration, _x.vehicle_cmd.ctrl_cmd.steering_angle, _x.vehicle_cmd.ctrl_cmd.steering_speed, _x.vehicle_cmd.emergency, _x.control_mode,) = _get_struct_10d2i().unpack(str[start:end])
      return self
