...
"""autogenerated by genpy from smartcar_msgs/My_TrajectoryArray.msg. Do not edit."""
import codecs
import sys
...
class My_TrajectoryArray(genpy.Message):
  _md5sum = "5ccdd33f237885519dadb3b742c24919"
  _type = "smartcar_msgs/My_TrajectoryArray"
...
float64 gear
"""
  __slots__ = ['header','lanes','num']
  _slot_types = ['std_msgs/Header','smartcar_msgs/My_Trajectory[]','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(My_TrajectoryArray, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = smartcar_msgs.msg.My_Trajectory()
        _v3 = val1.header
        start = end
        end += 4
        ...
        for i in range(0, length):
          val2 = smartcar_msgs.msg.My_Trajectory_Point()
          _x = val2
          start = end
          end += 104
        ...
        (val1.num,) = _get_struct_i().unpack(str[start:end])
