...
"""autogenerated by genpy from smartcar_msgs/VscanTrackedArray.msg. Do not edit."""
import codecs
import sys
...
class VscanTrackedArray(genpy.Message):
  ...
  _type = "smartcar_msgs/VscanTrackedArray"
...
float32 lb"""
  ...
  _slot_types = ['std_msgs/Header','smartcar_msgs/VscanTracked[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = smartcar_msgs.msg.VscanTracked()
        _v3 = val1.position
        _x = _v3
        start = end
        end += 24
