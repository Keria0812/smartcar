...
"""autogenerated by genpy from smartcar_msgs/Signals.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','smartcar_msgs/ExtractedPosition[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = smartcar_msgs.msg.ExtractedPosition()
        _x = val1
        start = end
        end += 57
