// Generated by gencpp from file object_msgs/State.msg
// DO NOT EDIT!


#ifndef OBJECT_MSGS_MESSAGE_STATE_H
#define OBJECT_MSGS_MESSAGE_STATE_H
...
struct State_
{
  ...
  _acceleration_reliable_type acceleration_reliable;
   ...
   typedef std::vector< ::object_msgs::PredictedPath_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::object_msgs::PredictedPath_<ContainerAllocator> >> _predicted_paths_type;
  ...
  typedef boost::shared_ptr< ::object_msgs::State_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::object_msgs::State_<ContainerAllocator> const> ConstPtr;

}; // struct State_

typedef ::object_msgs::State_<std::allocator<void> > State;

typedef boost::shared_ptr< ::object_msgs::State > StatePtr;
typedef boost::shared_ptr< ::object_msgs::State const> StateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::object_msgs::State_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::object_msgs::State_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::object_msgs::State_<ContainerAllocator1> & lhs, const ::object_msgs::State_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::object_msgs::State_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::object_msgs::State_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::object_msgs::State_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::object_msgs::State_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::object_msgs::State_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::object_msgs::State_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::object_msgs::State_<ContainerAllocator> >
{
  ...
  static const char* value(const ::object_msgs::State_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xadee6436156f6f80ULL;
  static const uint64_t static_value2 = 0xa5204905e49c421dULL;
};

template<class ContainerAllocator>
struct DataType< ::object_msgs::State_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::object_msgs::State_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::object_msgs::State_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::object_msgs::State_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::object_msgs::State_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.predicted_paths.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::object_msgs::PredictedPath_<ContainerAllocator> >::stream(s, indent + "    ", v.predicted_paths[i]);
    }
  }
};
...
#endif // OBJECT_MSGS_MESSAGE_STATE_H
