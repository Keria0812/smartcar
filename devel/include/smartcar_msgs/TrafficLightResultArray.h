...
struct TrafficLightResultArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::smartcar_msgs::TrafficLightResult_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::smartcar_msgs::TrafficLightResult_<ContainerAllocator> >> _results_type;
...
bool operator==(const ::smartcar_msgs::TrafficLightResultArray_<ContainerAllocator1> & lhs, const ::smartcar_msgs::TrafficLightResultArray_<ContainerAllocator2> & rhs)
{
