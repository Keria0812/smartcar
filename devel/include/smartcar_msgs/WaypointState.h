// Generated by gencpp from file smartcar_msgs/WaypointState.msg
// DO NOT EDIT!


#ifndef SMARTCAR_MSGS_MESSAGE_WAYPOINTSTATE_H
#define SMARTCAR_MSGS_MESSAGE_WAYPOINTSTATE_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::smartcar_msgs::WaypointState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::smartcar_msgs::WaypointState_<ContainerAllocator> const> ConstPtr;

}; // struct WaypointState_

typedef ::smartcar_msgs::WaypointState_<std::allocator<void> > WaypointState;

typedef boost::shared_ptr< ::smartcar_msgs::WaypointState > WaypointStatePtr;
typedef boost::shared_ptr< ::smartcar_msgs::WaypointState const> WaypointStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::smartcar_msgs::WaypointState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::smartcar_msgs::WaypointState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::smartcar_msgs::WaypointState_<ContainerAllocator1> & lhs, const ::smartcar_msgs::WaypointState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::smartcar_msgs::WaypointState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::smartcar_msgs::WaypointState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::smartcar_msgs::WaypointState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::smartcar_msgs::WaypointState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::smartcar_msgs::WaypointState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::smartcar_msgs::WaypointState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::smartcar_msgs::WaypointState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::smartcar_msgs::WaypointState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x623a0ffbb0a05249ULL;
  static const uint64_t static_value2 = 0x0adc981c2a3e8eddULL;
};

template<class ContainerAllocator>
struct DataType< ::smartcar_msgs::WaypointState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::smartcar_msgs::WaypointState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "int32 aid\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::smartcar_msgs::WaypointState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::smartcar_msgs::WaypointState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::smartcar_msgs::WaypointState_<ContainerAllocator>& v)
  {
    s << indent << "aid: ";
...
#endif // SMARTCAR_MSGS_MESSAGE_WAYPOINTSTATE_H
