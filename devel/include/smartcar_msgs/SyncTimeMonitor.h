// Generated by gencpp from file smartcar_msgs/SyncTimeMonitor.msg
// DO NOT EDIT!


#ifndef SMARTCAR_MSGS_MESSAGE_SYNCTIMEMONITOR_H
#define SMARTCAR_MSGS_MESSAGE_SYNCTIMEMONITOR_H
...
struct SyncTimeMonitor_
{
  ...
  typedef boost::shared_ptr< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> const> ConstPtr;

}; // struct SyncTimeMonitor_

typedef ::smartcar_msgs::SyncTimeMonitor_<std::allocator<void> > SyncTimeMonitor;

typedef boost::shared_ptr< ::smartcar_msgs::SyncTimeMonitor > SyncTimeMonitorPtr;
typedef boost::shared_ptr< ::smartcar_msgs::SyncTimeMonitor const> SyncTimeMonitorConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator1> & lhs, const ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> >
{
  ...
  static const char* value(const ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8c6a4dd195d4ccc3ULL;
  static const uint64_t static_value2 = 0x1d38fad617327689ULL;
};

template<class ContainerAllocator>
struct DataType< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::smartcar_msgs::SyncTimeMonitor_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // SMARTCAR_MSGS_MESSAGE_SYNCTIMEMONITOR_H
