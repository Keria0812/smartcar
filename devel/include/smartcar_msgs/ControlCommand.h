...
bool operator==(const ::smartcar_msgs::ControlCommand_<ContainerAllocator1> & lhs, const ::smartcar_msgs::ControlCommand_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::smartcar_msgs::ControlCommand_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x4c9d4b2ad7fccef1ULL;
  static const uint64_t static_value2 = 0x741b334eb90a1effULL;
};
...
struct Definition< ::smartcar_msgs::ControlCommand_<ContainerAllocator> >
{
  static const char* value()
  {
    return "float64 linear_velocity #m/s\n"
