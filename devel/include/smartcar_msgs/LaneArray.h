...
struct LaneArray_
{
  ...
  _id_type id;
   ...
   typedef std::vector< ::smartcar_msgs::Lane_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::smartcar_msgs::Lane_<ContainerAllocator> >> _lanes_type;
  _lanes_type lanes;
...
bool operator==(const ::smartcar_msgs::LaneArray_<ContainerAllocator1> & lhs, const ::smartcar_msgs::LaneArray_<ContainerAllocator2> & rhs)
{
