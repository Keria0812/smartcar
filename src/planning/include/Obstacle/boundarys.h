...
public:
  ...
  ST_Boundary& operator=(const ST_Boundary& other)
  {
  if (this == &other)
  return *this;

  boundary_type_ = other.boundary_type_;
  upper_points_ = other.upper_points_;
  lower_points_ = other.lower_points_;
  characteristic_length_ = other.characteristic_length_;
  obstacle_id = other.obstacle_id;
  bottom_left_point_ = other.bottom_left_point_;
  bottom_right_point_ = other.bottom_right_point_;
  upper_left_point_ = other.upper_left_point_;
  upper_right_point_ = other.upper_right_point_;
  time_start_s = other.time_start_s;
  time_end_s = other.time_end_s;
  obstacle_position = other.obstacle_position;
  obstacle_velocity = other.obstacle_velocity;
  obstacle_theta = other.obstacle_theta;
  centerpoint = other.centerpoint;
  obstacle_length = other.obstacle_length;
  obstacle_width = other.obstacle_width;
  is_static_obstacle = other.is_static_obstacle;
  obstacle_type = other.obstacle_type;
  min_s_ = other.min_s_;
  max_s_ = other.max_s_;
  max_t_ = other.max_t_;
  min_t_ = other.min_t_;
  ...
  ST_Boundary(const ST_Boundary& other)
  {
  boundary_type_ = other.boundary_type_;
  upper_points_ = other.upper_points_;
  lower_points_ = other.lower_points_;
