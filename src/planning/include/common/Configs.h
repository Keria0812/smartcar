...
public:
  ...
  double FLAGS_longitudinal_jerk_lower_bound = -0.4; // The lower bound of longitudinal jerk.
  double FLAGS_longitudinal_jerk_upper_bound = 2; // The upper bound of longitudinal jerk
