 ...
 * @LastEditTime: 2024-01-17 18:42:04
 * @FilePath: /miniEV/src/planning/src/Lattice_planner/constraint_checker.cpp
 */
...
ConstraintChecker::Result ConstraintChecker::ValidTrajectory(const DiscretizedTrajectory &trajectory) const
{
  ...
  for (const auto &p : trajectory)
  {
    ...
    if (!WithinRange(lon_a, Config_.FLAGS_longitudinal_acceleration_lower_bound, Config_.FLAGS_longitudinal_acceleration_upper_bound))
    {
      ...
      //           << ", bound [" << Config_.FLAGS_longitudinal_acceleration_lower_bound << ", "
      //           << Config_.FLAGS_longitudinal_acceleration_upper_bound << "]."
      //           << "\n";
